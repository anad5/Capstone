...
from heuristic import calc_susceptibility, calc_degree, calc_centrality
...
with open('network_scores.txt', 'w') as file:
    # Write susceptibility scores to the file
    ...
    # Write degree scores to the file
    file.write("\nDegree Scores:\n")
    for node, score in deg_score.items():
        file.write(f"Node {node}: {score}\n")

#     # Write centrality scores to the file
#     file.write("\nCentrality Scores:\n")
